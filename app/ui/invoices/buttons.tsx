import { deleteBank, deleteReminder, updateBank } from '@/app/lib/actions'
...
export function UpdateReminderButton({ reminder }: { reminder: REMINDER }) {
	...
	return (
		<Link href={`/dashboard/reminders/${id}/edit`} className="rounded-md border p-2 hover:bg-gray-100">
